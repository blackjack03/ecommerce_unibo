...
!(function (t) {
    ...
    function S(t) {
        ...
        if (this instanceof S == !1) throw new TypeError("Failed to construct 'Promise': Please use the 'new' operator, this object constructor cannot be called as a function.");
        (this._then = []),
            (function (t, e) {
                function n(t) {
                    g(e, t);
    ...
    (S.prototype = {
        ...
        then: function (t, e) {
            ...
            return (!e && !t) || this._handled || ((this._handled = !0), "rejected" === this._state && s && m(j, this)), "fulfilled" === this._state || "rejected" === this._state ? m(p, n) : this._then.push(n), n.then;
        },
        catch: function (t) {
    ...
    function _(t, n) {
        ...
        return new E(function (n, c) {
            if ("function" == typeof o)
                o(t, { mode: "cors", cache: "default", headers: new Headers(e({}, "fa-kit-token", i)) })
                    .then(function (t) {
    ...
    function P(t, e) {
        ...
        var d = s.map(function (n) {
            return new E(function (r, a) {
                _(n.customCss ? c(t) : i(t, { addOn: n.addOn, minify: t.minify.enabled }), e)
                    .then(function (i) {
                        r(
                            k(
                                i,
    ...
    try {
        if (window.FontAwesomeKitConfig) {
            var I = window.FontAwesomeKitConfig,
                U = {
                    detectingConflicts: I.detectConflictsUntil && new Date() <= new Date(I.detectConflictsUntil),
                ...
                .then(function (t) {
                    t.map(function (t) {
                        ...
                        U.detectingConflicts &&
                            D &&
                            L(function () {
                                D.setAttributeNode(document.createAttribute(U.detectionIgnoreAttr));
                                var t = (function (t, e) {
                                    var n = document.createElement("script");
                                    return (
                                        e && e.detectionIgnoreAttr && n.setAttributeNode(document.createAttribute(e.detectionIgnoreAttr)),
                                        (n.src = i(t, { baseFilename: "conflict-detection", fileSuffix: "js", subdir: "js", minify: t.minify.enabled })),
                                        n
                                    );
                                })(I, U);
